...
/** 后续添加 */
// TODO: - 添加badge
@property (nonatomic) UILabel *badgeView;
...
//            CGSize textSize = [text sizeWithAttributes:@{NSFontAttributeName:self.badgeView.font}];
//
//            if (textSize.width > self.badgeView.height) {
//                self.badgeView.width = 16 + textSize.width;
//            } else {
...
- (UILabel *)badgeView {
    if (!_badgeView) {
        UILabel *view = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, 8, 8)];
        view.textAlignment = NSTextAlignmentCenter;
        view.textColor = [UIColor whiteColor];
        view.font = [UIFont systemFontOfSize:11];
        view.layer.cornerRadius = 4;
        view.clipsToBounds = YES;
        view.backgroundColor = [UIColor colorWithRed:1.0 green:59/255.0 blue:48/255.0 alpha:1];

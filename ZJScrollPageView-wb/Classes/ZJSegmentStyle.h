...
@property (assign, nonatomic) CGFloat scrollLineOffsetY;

/** 滚动条的颜色 */
@property (strong, nonatomic) UIColor *scrollLineColor;
@property (strong, nonatomic) UIImage *scrollLineImage;
/** 遮盖的颜色 */
...
@property (nonatomic, assign) NSInteger segmentAndContentMargin;
@end
